 ...
 * range names are taken from Vuetify (https://github.com/akamejs).
 *
...
const breakpoint = {
  ...
  watch: {
    breakpoint (val) {
      this.$akame.breakpoint = val
    }
  },

  created () {
    this.$akame.breakpoint = this.breakpoint
  },
  ...
  methods: {
    onResize () {
      ...
      // https://github.com/akamejs/akame/pull/2997
