...
const builds = {
  development: {
    config: {
      ...
      plugins: [
        new ExtractTextPlugin('akame.css')
      ]
    }
  },
  production: {
    config: {
      output: {
        filename: 'akame.min.js',
        libraryTarget: 'umd'
      },
      plugins: [
        new ExtractTextPlugin('akame.min.css')
      ]
    },
    env: 'production'
  },
  /*
  esm: {
    filename: 'akame.esm.js',
    libraryTarget: 'esm',
    env: 'production'
  },
  commonjs: {
    filename: 'akame.common.js',
